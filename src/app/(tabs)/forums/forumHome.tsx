    ...
    return (
        <ParallaxScrollView
            ...
            <ThemedView style={styles.titleContainer}>
                ...
                <ThemedText type="screenTitle">Forum 1</ThemedText>
            </ThemedView>
            <ThemedView style={styles.listContainer}>
                <Link href="/(tabs)/forums/forumPost">
                    <ThemedText type="link">Poste 1</ThemedText>
                </Link>
                <Link href="/(tabs)/forums/forumPost">
                    <ThemedText type="link">Poste 2</ThemedText>
                </Link>
            </ThemedView>
        </ParallaxScrollView>
    );
